...
const ContentsDetail = ({ context, title, contents, tags, createdAt, description }: Props) => {
  return (
    <div tw="relative py-12 overflow-hidden">
          ...
          <svg tw="absolute top-12 left-full transform translate-x-32" width="404" height="384" fill="none" viewBox="0 0 404 384">
            <defs>
              <pattern id="74b3fd99-0a6f-4271-bef2-e80eeafdf357" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
                <rect x="0" y="0" width="4" height="4" tw="text-gray-200 dark:text-gray-600" fill="currentColor" />
              </pattern>
            </defs>
      ...
      <div tw="relative px-4 sm:px-6 lg:px-8">
        <div tw="text-lg max-w-prose mx-auto">
          <h1>
            ...
            <span
              tw="block text-3xl text-center leading-8 font-extrabold tracking-tight sm:text-4xl
            ...
            {createdAt !== '' && (
              <div
                tw="mt-3 flex items-center justify-end text-base
        ...
        <div
          tw="mt-6 text-gray-500 prose prose-indigo dark:prose-dark lg:prose-lg mx-auto"
